 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define APP_DEBUG(formate, ...)  printf("[%s:%d] " formate "\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define APP_INFO(formate, ...)  printf("[%s:%d] " formate "\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define APP_WARN(formate, ...)  printf("[%s:%d] " formate "\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
 ...
 * @param entry The text (or builder of the text) for the log entry.
 */
#define APP_ERROR(formate, ...)  printf("[%s:%d] " formate "\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
/**
 * Send a CRITICAL severity log line.
 *
 * @param loggerArg The Logger to send the line to.
 * @param entry The text (or builder of the text) for the log entry.
 */
#define APP_CRITICAL(formate, ...) printf("[%s:%d] " formate "\n", __FUNCTION__, __LINE__, ##__VA_ARGS__)
