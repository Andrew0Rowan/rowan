...
public:
    ...
    void ntpSerivceSetupNotify();

    bool waitFor(const DuerLinkNetworkStatus networkStatus,
        const std::chrono::seconds duration = std::chrono::seconds(600));
