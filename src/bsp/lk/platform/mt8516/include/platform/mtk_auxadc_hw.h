...
#define AUXADC_BASE			(IO_PHYS +0x01003000)
#define AUXADC_CLK_STA		(IO_PHYS + 0x00000024)
#define AUXADC_CLK_CLR		(IO_PHYS + 0x00000084)
#define AUXADC_CLK_SET		(IO_PHYS + 0x00000054)

#define AUXADC1_SW_CG			(1 << 5)
#define AUXADC2_SW_CG			(1 << 15)
#define AUX_SW_CG_ADC			(1 << 30)	/*main clk*/
