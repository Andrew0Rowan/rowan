...
#define Channel_A_DRAMC_NAO_BASE_ADDRESS    (IO_PHYS + 0x00206000)
#define Channel_A_DRAMC_AO_BASE_ADDRESS     (IO_PHYS + 0x00207000)
#define Channel_A_PHY_BASE_ADDRESS          (IO_PHYS + 0x00211000)
#define Channel_B_PHY_BASE_ADDRESS          (IO_PHYS + 0x00212000)
