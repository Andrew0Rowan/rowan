...
#define P_Fld(val,fld) ((sizeof(upk)>1)?Fld2Msk32(fld):(((UINT32)(val)&((UINT32)(1<<Fld_wid(fld))-1))<<Fld_shft(fld)))

extern U32 u4Dram_Register_Read(unsigned long u4reg_addr);
extern U8 ucDram_Register_Write(unsigned long u4reg_addr, U32 u4reg_value);

extern void vIO32Write4BMsk(unsigned long reg32, U32 val32, U32 msk32);
extern void vIO32Write4BMsk_All(unsigned long reg32, U32 val32, U32 msk32);
#if 0
extern void vIO32Write4BMsk_C(U32 reg32, U32 val32, U32 msk32);
#endif
extern void vIO32Write4B_All(unsigned long reg32, U32 val32);
