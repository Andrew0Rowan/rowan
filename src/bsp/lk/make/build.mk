...
LK_TOP_DIR := $(PWD)
LIBDRAM = $(LK_TOP_DIR)/platform/mt8516/drivers/dram/libdram.a
...
$(OUTELF): $(ALLMODULE_OBJS) $(EXTRA_OBJS) $(LINKER_SCRIPT) $(EXTRA_LINKER_SCRIPTS)
	#@ar cq $(BUILDDIR)/platform/mt8516/drivers/dram/libdram.a $(DRAMK_OBJS)
	...
	$(NOECHO)$(LD) $(GLOBAL_LDFLAGS) -dT $(LINKER_SCRIPT) $(addprefix -T,$(EXTRA_LINKER_SCRIPTS)) \
		$(ALLMODULE_OBJS) $(EXTRA_OBJS) $(LIBGCC) $(LIBDRAM) -o $@
