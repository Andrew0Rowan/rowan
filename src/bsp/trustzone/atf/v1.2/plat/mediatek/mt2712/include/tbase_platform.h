...
// Enable PM hooks
#define TBASE_PM_ENABLE            (1U)
// Enable SiP fastcall routing to tbase
#define TBASE_SIP_ROUTE_ENABLE     (0U)
// Enable OEM fastcall routing to tbase
#define TBASE_OEM_ROUTE_ENABLE     (0U)
