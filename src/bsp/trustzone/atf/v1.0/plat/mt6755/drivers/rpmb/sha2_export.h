#ifndef _GCPU_EXPORT_H_
#define _GCPU_EXPORT_H_
...
/* exported functions   */
/* ==================== */
extern unsigned int sha256(const unsigned char *in, unsigned int inlen, unsigned char *hash);
extern unsigned int sha256_test(void);
extern unsigned int sha256_init(void);


#endif /* _GCPU_EXPORT_H_ */
