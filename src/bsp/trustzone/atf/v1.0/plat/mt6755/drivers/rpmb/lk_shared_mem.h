...
*  |           |           |     |         |           |       |         |       |         |    |           |           |
*  | i_key_pad |  message  | ... | padding | o_key_pad | hash1 | padding | hash2 | padding | iv | rpmb key  | operation | 
*  |           |           |     |         |           |       |         |       |         |    |           |           |
*    block_size   msg_size          128B     block_size  sha256   128B     sha256   128B     iv   block_size   mass data 
* 
*/
