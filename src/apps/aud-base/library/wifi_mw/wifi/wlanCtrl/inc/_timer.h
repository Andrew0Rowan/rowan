...
typedef struct
{
  int    u4Ticks;                    //Number of timer interrupts from startup
  int    u4Cycles;                   //System cycles from last timer interrupt
} HAL_RAW_TIME_32bit_T;

typedef struct
{
  int    u4Seconds;                  //Number of seconds from startup
  int    u4Micros;                   //Remainder in microsecond
} HAL_TIME_T;
