...
extern INT32 user_interface_send_key_to_all(APPMSG_T* t_msg, const CHAR* ps_name);
extern INT32 user_interface_send_key_to_sm(SM_MSG_BDY_E UI_BODY);
extern INT32 user_interface_send_key_to_assistant(SM_MSG_BDY_E UI_BODY);
