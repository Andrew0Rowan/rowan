...
do_compile() {
    ...
    oe_runmake -f ${WORKDIR}/debian/makefiles/adb.mk -C ${S}/core/adb clean
    oe_runmake -f ${WORKDIR}/debian/makefiles/adb.mk -C ${S}/core/adb
}

do_install() {
    install -d ${D}${bindir}
    install -m 0755 ${S}/core/adb/adb ${D}${bindir}
}
