DESCRIPTION = "Package group used by Mediatek Community to provide audio, video, networking and debug \
GStreamer plugins with the required hardware acceleration (if supported by the SoC)."
SUMMARY = "Mediatek Community package group - set of commonly used GStreamer 1.0 plugins"
LICENSE = "MIT"
